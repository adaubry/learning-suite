...
export const neutralTheme = {
  ...
  tokens: {
    ...
    "--color-accent": "light-dark(oklch(0.42 0.17 285), oklch(0.78 0.13 285))",
    "--color-accent-muted": "light-dark(oklch(0.94 0.025 285), oklch(0.42 0.17 285 / 26%))",
    ...
    "--color-text-accent": "light-dark(oklch(0.42 0.17 285), oklch(0.78 0.13 285))",
    ...
    "--color-icon-accent": "light-dark(oklch(0.42 0.17 285), oklch(0.78 0.13 285))",
