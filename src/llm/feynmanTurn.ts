...
// feynman_turn.v3.md (REVAMP v2, 2026-07-15 : + brouillon) attend ses variables
// en snake_case ; historique/points sont pré-formatés en lignes de texte ici
// (formatTemplateItem de L0 ne reconnaît que la forme {type, description}, pas
// {role, texte} ni {intitule, attendu}).
